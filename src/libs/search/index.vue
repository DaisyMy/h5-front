    ...
    <div ref="containerTarget" class=" group relative p-0.5 rounded-xl border-white duration-500 hover:bg-red-100/40">
        <div>
            ...
            <daisy-svg-icon v-show="inputValue" @click="handleClear" name="input-delete"
                ...
                fillClass="dark:fill-zinc-300"></daisy-svg-icon>
            <!-- 分割线 -->
            <div
        ...
        <transition name="slide">
            <div v-if="$slots.dropdown" v-show="isFocus"
                class="dark:bg-zinc-800 dark:border-zinc-600 max-h-[368px] w-full text-base overflow-auto bg-white absolute z-20 left-0 top-[56px] p-2 rounded border border-zinc-200 hover:shadow-3xl scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-900 scrollbar-track-transparent">
