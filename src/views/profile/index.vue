<template>
    <div class="h-full bg-zinc-200 dark:bg-zinc-800 duration-400 overflow-auto xl:pt-1">
        <div
            ...
            <!-- 移动端 navbar -->
            <daisy-navbar sticky v-if="isMobileTerminal" :clickLeft="onNavbarLeftClick">
                个人资料
            </daisy-navbar>
            <!-- pc 端 -->
            ...
            <div class="h-full w-full px-1 pb-4 text-sm mt-2 xl:w-2/3 xl:pb-0">
                ...
                <div class="py-1 xl:absolute xl:right-[16%] xl:text-center">
                    <span
                        class="w-8 inline-block mb-2 font-bold text-sm dark:text-zinc-300 xl:block xl:mx-auto">我的头像</span>
                    <!-- 头像部分 -->
                    <div class="relative w-[80px] h-[80px] group xl:cursor-pointer xl:left-[50%] xl:translate-x-[-50%]"
                        @click="onAvatarClick">
                        <img v-lazy :src="userStore.userInfo.avatar" alt=""
                        ...
                        <div
                            ...
                            <daisy-svg-icon name="change-header-image" class="w-2 h-2 m-auto mt-2"></daisy-svg-icon>
                ...
                <div class="py-1 xl:flex xl:items-center xl:my-1">
                    ...
                    <daisy-input v-model="userInfo.nickname" class="w-full" type="text" max="20"></daisy-input>
                </div>
                <!-- 职位 -->
                <div class="py-1 xl:flex xl:items-center xl:my-1">
                    <span class="w-8 block mb-1 font-bold dark:text-zinc-300 xl:mb-0">职位</span>
                    <daisy-input v-model="userInfo.title" class="w-full" type="text"></daisy-input>
                </div>
                <!-- 公司 -->
                <div class="py-1 xl:flex xl:items-center xl:my-1">
                    <span class="w-8 block mb-1 font-bold dark:text-zinc-300 xl:mb-0">公司</span>
                    <daisy-input v-model="userInfo.company" class="w-full" type="text"></daisy-input>
                </div>
                <!-- 个人主页 -->
                <div class="py-1 xl:flex xl:items-center xl:my-1">
                    <span class="w-8 block mb-1 font-bold dark:text-zinc-300 xl:mb-0">个人主页</span>
                    <daisy-input v-model="userInfo.homePage" class="w-full" type="text"></daisy-input>
                </div>
                <!-- 个人介绍 -->
                <div class="py-1 xl:flex xl:my-1">
                    <span class="w-8 block mb-1 font-bold dark:text-zinc-300 xl:mb-0">个人介绍</span>
                    <daisy-input v-model="userInfo.introduction" class="w-full" type="textarea" max="50"></daisy-input>
                </div>
                <!-- 保存修改 -->
                <daisy-button
                    class="w-full mt-2 mb-4 dark:text-zinc-300 dark:bg-zinc-800 xl:w-[160px] xl:ml-[50%] xl:translate-x-[-50%]"
                    :loading="loading" @click="onChangeProfile">保存修改</daisy-button>
                <!-- 移动端退出登录 -->
                <daisy-button v-if="isMobileTerminal"
